    ...
    return (
        <div class="flex h-[calc(100vh-80px)] items-center justify-center p-5 bg-white w-full">
            <div class="text-center">
                ...
                <h1 class="mt-5 text-[36px] font-bold text-slate-800 lg:text-[50px]">404 - Page non trouvée</h1>
                <p class="text-slate-600 mt-5 lg:text-lg">La page que vous recherchez n'existe pas ou <br />a été supprimée.</p>
            </div>
        </div>
    )
}
