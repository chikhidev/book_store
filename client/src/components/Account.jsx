...
const Account = () => {
  ...
  const [{ username, email, isAdmin, createdAt, bio, avatar }, setDetails] =
    useState(details);
  ...
  return (
    <div
      className="ease-soft-in-out xl:ml-68.5 relative h-full max-h-screen rounded-xl transition-all duration-200 md:px-24"
      id="panel"
    >
              ...
              <div className="relative flex flex-col h-full min-w-0 break-words bg-white border-0 shadow-soft-xl rounded-2xl bg-clip-border">
                ...
                <div className="flex-auto p-4">
                  ...
                  <ul className="flex flex-col pl-0 mb-0 rounded-lg">
                    ...
                    <li className="relative block py-2 pl-0 leading-normal bg-white border-0 border-t-0 text-sm text-inherit">
                      <strong className="text-slate-700">Member Since :</strong>{" "}
                  ...
                  <p className="leading-normal text-sm">
                    {
                        bio.length == 0 ? "Pas de biographie": bio
                    }
                  </p>
                </div>
              </div>
              ...
              <div className="relative flex flex-col h-full min-w-0 break-words bg-white border-0 shadow-soft-xl rounded-2xl bg-clip-border">
                ...
                <div className="flex-auto p-4">
                  ...
                  <ul className="flex flex-col pl-0 mb-0 rounded-lg">
                    ...
                    <div className="py-4">
                        <button onClick={handleLogout} type="button" className="focus:outline-none text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900">
                            Logout
                        </button>
                        <button onClick={null} type="button" className="focus:outline-none text-white bg-red-900 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900">
                            Delete account
                        </button>
                    </div>
                  </ul>
